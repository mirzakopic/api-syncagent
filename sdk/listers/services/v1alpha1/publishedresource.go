...
type PublishedResourceClusterLister interface {
	...
	List(selector labels.Selector) (ret []*servicesv1alpha1.PublishedResource, err error)
...
func (s *publishedResourceClusterLister) List(selector labels.Selector) (ret []*servicesv1alpha1.PublishedResource, err error) {
	err = cache.ListAll(s.indexer, selector, func(m interface{}) {
		ret = append(ret, m.(*servicesv1alpha1.PublishedResource))
	})
	return ret, err
}
...
type PublishedResourceLister interface {
	...
	// Objects returned here must be treated as read-only.
	Get(name string) (*servicesv1alpha1.PublishedResource, error)
...
func (s *publishedResourceLister) List(selector labels.Selector) (ret []*servicesv1alpha1.PublishedResource, err error) {
	err = kcpcache.ListAllByCluster(s.indexer, s.clusterName, selector, func(i interface{}) {
		ret = append(ret, i.(*servicesv1alpha1.PublishedResource))
	})
	return ret, err
}

// Get retrieves the PublishedResource from the indexer for a given workspace and name.
func (s *publishedResourceLister) Get(name string) (*servicesv1alpha1.PublishedResource, error) {
	...
	if !exists {
		return nil, errors.NewNotFound(servicesv1alpha1.Resource("publishedresources"), name)
	}
	return obj.(*servicesv1alpha1.PublishedResource), nil
}
...
// List lists all PublishedResources in the indexer for a workspace.
func (s *publishedResourceScopedLister) List(selector labels.Selector) (ret []*servicesv1alpha1.PublishedResource, err error) {
...
// Get retrieves the PublishedResource from the indexer for a given workspace and name.
func (s *publishedResourceScopedLister) Get(name string) (*servicesv1alpha1.PublishedResource, error) {
	key := name
	obj, exists, err := s.indexer.GetByKey(key)
	if err != nil {
		return nil, err
