...
import (
	...
	scopedclientset "k8c.io/servlet/sdk/clientset/versioned"
	clientset "k8c.io/servlet/sdk/clientset/versioned/cluster"
	servicesv1alpha1listers "k8c.io/servlet/sdk/listers/services/v1alpha1"
	...
	"k8c.io/servlet/sdk/informers/externalversions/internalinterfaces"
)
...
type PublishedResourceClusterInformer interface {
	...
	Lister() servicesv1alpha1listers.PublishedResourceClusterLister
}
	...
	return kcpinformers.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options metav1.ListOptions) (runtime.Object, error) {
				...
				return client.ServicesV1alpha1().PublishedResources().List(context.TODO(), options)
			},
			WatchFunc: func(options metav1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.ServicesV1alpha1().PublishedResources().Watch(context.TODO(), options)
			},
		},
		&servicesv1alpha1.PublishedResource{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *publishedResourceClusterInformer) Informer() kcpcache.ScopeableSharedIndexInformer {
	return f.factory.InformerFor(&servicesv1alpha1.PublishedResource{}, f.defaultInformer)
}

func (f *publishedResourceClusterInformer) Lister() servicesv1alpha1listers.PublishedResourceClusterLister {
	return servicesv1alpha1listers.NewPublishedResourceClusterLister(f.Informer().GetIndexer())
}
...
type PublishedResourceInformer interface {
	...
	Lister() servicesv1alpha1listers.PublishedResourceLister
}
...
func (f *publishedResourceInformer) Lister() servicesv1alpha1listers.PublishedResourceLister {
	return f.lister
}
...
func (f *publishedResourceScopedInformer) Lister() servicesv1alpha1listers.PublishedResourceLister {
	return servicesv1alpha1listers.NewPublishedResourceLister(f.Informer().GetIndexer())
}
